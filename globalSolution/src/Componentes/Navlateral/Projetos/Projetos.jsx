    ...
    return (
        <div id='projeto' className="max-w-[1040] m-auto md:pl-20 p-4 py-16">
            ...
            <div id='projeto' className="mx-auto max-w-4xl px-4 py-8">
                <h1 className="text-3xl font-bold text-center text-[#001b5e]">Monitoramento dos Resíduos Plásticos no Oceano</h1>
                ...
                <div className="container mt-5 mb-20">
                    <h1 className="text-center">Concentração de Plástico nos Oceanos</h1>
                    <div className="row">
